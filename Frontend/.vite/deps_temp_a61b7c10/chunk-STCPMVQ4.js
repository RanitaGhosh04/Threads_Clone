...
import {
  ...
  useMultiStyleConfig,
  useTheme
} from "./chunk-2AUPYQO5.js";
import {
  createContext
} from "./chunk-RHATMGAC.js";
import {
  require_jsx_runtime,
  useSafeLayoutEffect
...
function useVisualElement(Component3, visualState, props, createVisualElement2, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react26.useRef)(Boolean(optimisedAppearId) && !window.MotionHandoffIsComplete && ((_a = window.MotionHasOptimisedAnimation) === null || _a === void 0 ? void 0 : _a.call(window, optimisedAppearId)));
...
function usePresence() {
  ...
  const safeToRemove = (0, import_react36.useCallback)(() => onExitComplete && onExitComplete(id3), [id3, onExitComplete]);
...
//# sourceMappingURL=chunk-STCPMVQ4.js.map
